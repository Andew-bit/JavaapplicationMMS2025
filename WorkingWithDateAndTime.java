...
public  class WorkingWithDateAndTime{
	public static void main(String[] args){
		...
		LocalDate myDate = LocalDate.of(2026,3,12);
		...
		System.out.printf("The resumptionDate date is %s%n",resumptionDate);
		...
		System.out.printf("My exam will be on the %s%n",currentDate.plusDays(7));
		System.out.printf("The day is %s%n",currentDate.plusYears(2));
		...
		System.out.printf("Today's time is %s%n",currentTime);
		...
		System.out.printf("My exam will be by %s%n",currentTime.plusHours(7));
